materialAdmin
    ...
    .config(function ($stateProvider, $urlRouterProvider){
        ...
        $stateProvider 
            ...
            .state ('home', {
                url: '/home',
                templateUrl: 'views/dashboard/frm_dashboard_V1.html',
                resolve: {
            ...
            .state ('app.appointment', {
                url: '/appointment',
                templateUrl: 'views/Appointments/frm_appointments.html'
            })
            
            .state ('app.make', {
                url: '/make',
                templateUrl: 'views/Appointments/frm_MakeAppointment.html'
            })
            
           
            .state ('app.appointmentApproval', {
                url: '/recp',
                templateUrl: 'views/Appointments/frm_AppointmentApproval.html'
            })
             
            
            .state ('app.patient', {
                url: '/patient',
                templateUrl: 'views/patient/frm_patient.html'
            })
            
            .state ('app.patientDetails', {
                url: '/patientDetails/:params',
                templateUrl: 'views/patient/frm_patientDetails.html'
            })
             
             .state ('app.doctor', {
                url: '/doctor',
                templateUrl: 'views/administration/frm_doctor.html'
            })
            
            .state ('app.doctorDetails', {
                url: '/doctorDetails/:params',
                templateUrl: 'views/administration/frm_doctorDetails.html'
            })
            
            .state ('app.user', {
                url: '/user',
                templateUrl: 'views/administration/frm_user.html'
            })
            
            .state ('app.userDetails', {
                url: '/userDetails/:params',
                templateUrl: 'views/administration/frm_userDetails.html'
            })
            ...
            .state ('auth', {
                url: '/login',
                templateUrl: 'views/login/elLogin.html'
            })
            
            .state ('app.hosp', {
                url: '/hospital',
                templateUrl: 'views/administration/frm_myHospital.html'
            })
            
            .state ('app.staff', {
                url: '/staff',
                templateUrl: 'views/administration/frm_staff.html'
            })
            
            .state ('app.subscription', {
                url: '/subs',
                templateUrl: 'views/administration/frm_subscription.html'
            })
            ...
            .state ('app.testDetails', {
                url: '/testDetails/:params',
                templateUrl: 'views/test/testDetails.html'
            })
            
            
            .state ('app.appointmentList', {
                url: '/appList',
                templateUrl: 'views/Appointments/frm_AppointmentV1.html'
            })
            
            .state ('app.treatment', {
                url: '/treat/:params',
                templateUrl: 'views/patient/frm_treatmentV1.html',
                controller : 'treatmentCtrlV1',
            ...
            .state ('app.invoice_v', {
                url: '/inv',
                templateUrl: 'views/Invoice/frm_invoice.html'
            })
            
            .state ('app.iPrint', {
                url: '/iPrint/:params',
                templateUrl: 'views/Invoice/frm_InvoiceDetails.html'
            })
            
            .state ('app.iDetails', {
                url: '/ivMaster',
                templateUrl: 'views/administration/frm_MedicalTestMaster.html'
            })
            
            .state ('app.investigationMaster', {
                url: '/iv',
                templateUrl: 'views/asset/frm_investigation.html'
            })
            ...
            .state ('app.investigationDetails', {
                url: '/investigation/:params',
                templateUrl: 'views/asset/frm_investigationDetails.html'
            })
            
             .state ('app.missedCallList', {
                url: '/mcp',
                templateUrl: 'views/Appointments/frm_MissedCallPList.html'
            })
           
             .state ('app.lov', {
                url: '/lov',
                templateUrl: 'views/administration/frm_lov.html'
            })
            
             .state ('app.sms', {
                url: '/sms',
                templateUrl: 'views/sms/frm_sms.html'
            })
            
            
            .state ('app.slotManager', {
                url: '/slot',
                templateUrl: 'views/doctor/frm_doctorSlots.html'
            })
