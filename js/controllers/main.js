materialAdmin
    ...
    .controller('materialadminCtrl', function($timeout, $state, $scope, growlService,$rootScope ){
        //Welcome Message
        //growlService.growl('Welcome back Eltoros!', 'inverse')
        
        
        $rootScope.app = {}
        $rootScope.app.pageData = "";
     ...
     /*   $scope.$watch(function() {
        	  return $rootScope.app.pageData;
        	}, function() {
        	  console.log($rootScope.app.pageData);
        }, true);*/
    ...
    // Header
    // =========================================================================
    .controller('headerCtrl', function($timeout, messageService,$state,$scope){
