materialAdmin
	...
	.service('FrameworkService',  function($resource,$http){
		 ...
		 return {
			 getGenericPostCall: function(_url,params,SuccessCallBack,ErrorCallBack){
		           // console.log("got a call ");
		           // console.info(_url + "      : " + FrameworkService.ServerAddress   + _url);
		            $.ajax({
						url : FrameworkService.ServerAddress + _url,
						data : params,
						method:"POST",
						cache : false,
		        ...
		        getGenericGetCall: function(_url,SuccessCallBack,ErrorCallBack){
		        	
		        	//console.info(_url + "      : " + FrameworkService.ServerAddress   + _url);
		        	
		        	 $http.get(FrameworkService.ServerAddress + _url)
		        ...
		        ChangePatientStatus: function(params,SuccessCallBack,ErrorCallBack){
			           // console.log("got a call ");
			           // console.info(_url + "      : " + FrameworkService.ServerAddress   + _url);
		        	var req = {
		        			 method: 'POST',
		        			 url: FrameworkService.ServerAddress + 'ChangePatientStatus.php', 
		        			 data:  params
		        	}
		        ...
		        getDecryptedString : function(str){		        	
		        	var parsed = JSON.parse(LZString.decompressFromBase64(str));
		        	return parsed;
		        }
